...
# ==============================================================================
    ...
    # ==============================================================================
    # Usamos .strip() e verificamos se o texto contém "Carômetro" para evitar erros de emoji ou espaços
    elif "Carômetro" in doc_mode:
                    ...
                    with cols[idx_col]:
                        try:
                            ...
                            with st.container(border=True):
                                ...
                                # Usamos um ID único para cada botão baseado no nome
